...
class Detector(object):
    def __init__(self, args, model=None, seq_num=2):
        ...
        img_list = os.listdir(os.path.join(self.args.mot_path, 'data/MOT17/images', self.seq_num, 'img1'))
        img_list = [os.path.join(self.args.mot_path, 'data/MOT17/images', self.seq_num, 'img1', _) for _ in img_list if
    ...
    def eval_seq(self):
        data_root = os.path.join(self.args.mot_path, 'data/MOT17/images')
        #print("data_root",data_root,"\n")
        #result_filename = os.path.join(self.predict_path, 'gt.txt')
        result_filename = os.path.join(self.predict_path,  f'{self.seq_num}.txt')
        #print("self.predict_path",self.predict_path,'\n')
